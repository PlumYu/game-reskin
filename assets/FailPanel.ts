...
export default class FailPanel extends Component {
    ...
    private buildUI(): void {
        ...
        const title = this.createShadowLabel('title', this.contentRoot, '奶茶没找着！', 76, COLOR_WHITE, true);
        title.setPosition(0, titleY, 0);

        const subtitle = this.createShadowLabel('subtitle', this.contentRoot, '差一点就把奶茶找出来了', 34, GOLD, true);
