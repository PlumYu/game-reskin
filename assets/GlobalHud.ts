...
const HUD_STAMINA_PILL_WIDTH = 268;
const HUD_STAMINA_PILL_HEIGHT = 66;
const HUD_STAMINA_LEFT_OFFSET = -4;
...
const HUD_NUMBER_TEXT = new Color(255, 255, 255, 255);
const HUD_NUMBER_SHADOW = new Color(40, 60, 90, 160);
...
export default class GlobalHud extends Component {
    ...
    private buildHud(): void {
        ...
        const staminaTextGroupWidth = this.scaleHud(190);
        const staminaValueWidth = Math.round(staminaTextGroupWidth * 0.38);
