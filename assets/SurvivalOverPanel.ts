...
export default class SurvivalOverPanel extends Component {
    ...
    private createSettlementTitle(parent: Node): void {
        ...
        const title = createLabel('SurvivalSettlementTitle', parent, this.isWin ? '奶茶生存成功' : '奶茶生存失败', 62, this.isWin ? GOLD_TEXT : COLOR_WHITE, true);
    ...
    private createStats(parent: Node): void {
        ...
        const foundSuffix = createLabel('SurvivalFoundSuffix', found, '杯奶茶', 34, COLOR_WHITE, true);
