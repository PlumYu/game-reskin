...
export function installDrawGridHud(target: any): void {
    ...
    ensureSurvivalFoundCowsPanel: function (): Node | null {
        ...
        this.setCounterPanelCaption(root, '找到奶茶:', valueLabel);
    ...
    setupRuleBoxNodes: function () {
        ...
        const leftLabel = labels.find(label => label.string.indexOf('每个部门') >= 0 || label.string.indexOf('每种颜色') >= 0 || label.string.indexOf('每种气球') >= 0 || label.string.indexOf('每种口味') >= 0);
